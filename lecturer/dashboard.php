                ...
                <div class="row g-4">
                        ...
                        <div class="container">
                            ...
                            <div class="containers rounded-4 p-4">
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <a href="create-lecture.php" class="btn btn-outline-warning w-100">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="containers rounded-4 p-4">
                            ...
                            <div class="lecture-item d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="fw-bold mb-1">Lecture Title 1</h6>
                                    <small class="text-muted">Date: 2023-01-01</small>
                                </div>
                                <a href="" class="btn btn-sm btn-success">Approve</a>
                            </div>
