        ...
        <div class="">
            ...
            <section class="container my-4">
                ...
                <div class="containers p-4 rounded-4">
                    <form action="../controllers/createLecture.php" method="POST" id="createLectureForm" novalidate>
                        <!-- Hidden -->
                        <input type="hidden" name="lecturer_id" value="<?= $_SESSION['userId'] ?>">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-bold" for="start_time">Start Time</label>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="qr_window" name="qr_window" min="5" max="120" value="20">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="location" name="location" class="form-control" placeholder="Fetching your location..." readonly>
